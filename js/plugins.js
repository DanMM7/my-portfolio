...
!(function (t) {
                ...
                this.each(function () {
                    ...
                    if (this !== document && this !== window)
                        return !document.scrollingElement || (this !== document.documentElement && this !== document.body)
                            ? (e[n]() > 0 ? l.push(this) : (e[n](1), (o = e[n]() > 0), o && l.push(this), e[n](0)), void 0)
    ...
    t.fn.extend({
        ...
        smoothScroll: function (l, o) {
            ...
            return (
                this.unbind("click.smoothscroll").bind("click.smoothscroll", function (l) {
                    var o = this,
                        r = t(this),
        ...
        (t.smoothScroll = function (e, l) {
            ...
            var n,
                ...
                d = {};
            "number" == typeof e
                ? ((n = t.extend({ link: null }, t.fn.smoothScroll.defaults, o)), (r = e))
                : ((n = t.extend({ link: null }, t.fn.smoothScroll.defaults, e || {}, o)), n.scrollElement && ((f = "position"), "static" === n.scrollElement.css("position") && n.scrollElement.css("position", "relative"))),
                (u = "left" === n.direction ? "scrollLeft" : u),
                n.scrollElement ? ((s = n.scrollElement), /^(?:HTML|BODY)$/.test(s[0].nodeName) || (a = s[u]())) : (s = t("html, body").firstScrollable(n.direction)),
                n.beforeScroll.call(s, n),
                (r = "number" == typeof e ? e : l || (t(n.scrollTarget)[f]() && t(n.scrollTarget)[f]()[n.direction]) || 0),
                (h[u] = r + a + n.offset),
                (i = n.speed),
                "auto" === i && ((c = h[u] - s.scrollTop()), 0 > c && (c *= -1), (i = c / n.autoCoefficient)),
                (d = {
                    duration: i,
                    easing: n.easing,
                    complete: function () {
...
!(function (a) {
    a.fn.animatedModal1 = function (n) {
        function o() {
            m.css({ "z-index": e.zIndexOut }), e.afterClose();
        }
        function t() {
...
!(function (a) {
    a.fn.animatedModal2 = function (n) {
        function o() {
            m.css({ "z-index": e.zIndexOut }), e.afterClose();
        }
        function t() {
...
!(function (a) {
    a.fn.animatedModal3 = function (n) {
        function o() {
            m.css({ "z-index": e.zIndexOut }), e.afterClose();
        }
        function t() {
...
!(function (a) {
    a.fn.animatedModal4 = function (n) {
        function o() {
            m.css({ "z-index": e.zIndexOut }), e.afterClose();
        }
        function t() {
...
!(function (a) {
    a.fn.animatedModal5 = function (n) {
        function o() {
            m.css({ "z-index": e.zIndexOut }), e.afterClose();
        }
        function t() {
...
!(function (a) {
    a.fn.animatedModal6 = function (n) {
        function o() {
            m.css({ "z-index": e.zIndexOut }), e.afterClose();
        }
        function t() {
...
!(function (a) {
    a.fn.animatedModal7 = function (n) {
        function o() {
            m.css({ "z-index": e.zIndexOut }), e.afterClose();
        }
        function t() {
...
!(function (a) {
    a.fn.animatedModal8 = function (n) {
        function o() {
            m.css({ "z-index": e.zIndexOut }), e.afterClose();
        }
        function t() {
...
!(function (a) {
    a.fn.animatedModal9 = function (n) {
        function o() {
            m.css({ "z-index": e.zIndexOut }), e.afterClose();
        }
        function t() {
...
!(function (a) {
    a.fn.animatedModal10 = function (n) {
        function o() {
            m.css({ "z-index": e.zIndexOut }), e.afterClose();
        }
        function t() {
...
!(function (a) {
    a.fn.animatedModal11 = function (n) {
        function o() {
            m.css({ "z-index": e.zIndexOut }), e.afterClose();
        }
        function t() {
...
!(function (a) {
    a.fn.animatedModal12 = function (n) {
        function o() {
            m.css({ "z-index": e.zIndexOut }), e.afterClose();
        }
        function t() {
...
!(function (a) {
    a.fn.animatedModal13 = function (n) {
        function o() {
            m.css({ "z-index": e.zIndexOut }), e.afterClose();
        }
        function t() {
...
!(function (a) {
    a.fn.animatedModal14 = function (n) {
        function o() {
            m.css({ "z-index": e.zIndexOut }), e.afterClose();
        }
        function t() {
                ...
                this.each(function () {
                    ...
                    e
                        ? i
                              ...
                              .each(function () {
                                  var b = a(this);
                                  b.is("img:has-src") && !b.is("[srcset]") && j.push({ src: b.attr("src"), element: b[0] }),
